...
!function (t, a) {
    !function (t) {
        ...
        a.DEFAULT = {
            ...
            navbarSmall: !1,
            fadeBetweenPages: !0,
            php: {twitter: "./php/twitter/tweet.php", instagram: "./php/instagram/instagram.php"}
        }, a.prototype.init = function (a) {
            function e() {
                o.options.navbarSmall || (o.options.navbarSmall = t(".navbar-youplay").hasClass("navbar-small")), t('[data-toggle="tooltip"]').tooltip({container: "body"}), t('[data-toggle="popover"]').popover(), o.fadeBetweenPages(), o.initAnchors(), o.initFacebook(), o.initInstagram(), o.initTwitter(), o.initOwlCarousel(), o.initMagnificPopup(), o.initSliderRevolution(), o.initIsotope(), o.initHexagonRating(), o.navbarCollapse(), o.options.navbarSmall || (o.$window.on("scroll", function () {
            ...
            if ("undefined" != typeof t.fn.owlCarousel) {
                ...
                t(".owl-carousel").each(function () {
                    ...
                    t(this).owlCarousel({
                        ...
                        responsive: {0: {items: 3}, 500: {items: 4}, 992: {items: 5}, 1200: {items: 6}}
                    ...
                    t(this).addClass("owl-carousel").owlCarousel({
                        ...
                        autoplayHoverPause: !0,
                        navText: ["", ""],
                        responsive: {0: {items: 1}, 500: {items: 2}, 992: {items: 3}, 1200: {items: 4}}
                    }).addClass(e), i && t("<style>." + e + " .owl-item { padding-left: " + i + "px; padding-right: " + i + "px; }</style>").appendTo("head")
            ...
            if ("undefined" != typeof t.fn.magnificPopup) {
                var a = {
                    ...
                    removalDelay: 300,
                    image: {verticalFit: !0, tError: '<a href="%url%">The image #%curr%</a> could not be loaded.'}
                };
                t(".image-popup").magnificPopup(t.extend({type: "image"}, a)), t(".video-popup").magnificPopup(t.extend({type: "iframe"}, a)), t(".gallery-popup").magnificPopup(t.extend({
            ...
            if ("undefined" != typeof t.fn.isotope) {
                t(".isotope").each(function () {
                    var a = t(this).find(".isotope-options"),
                        e = t(this).find(".isotope-list").isotope({itemSelector: ".item"});
            ...
            this.options.parallax && !this.isMobile && ("undefined" != typeof skrollr && "undefined" == typeof this.skrollr && (this.skrollr = skrollr.init({
                ...
                t(this).jarallax({speed: isNaN(a) ? .4 : a})
                ...
                t(this).jarallax({
                    ...
                    onScroll: function (t) {
                        ...
                        a.css({transform: "translate3d(0, " + o + "px, 0)"}), e.css({
                ...
                t(this).jarallax({
                    ...
                    onScroll: function (t) {
                        ...
                        a.css({transform: "translate3d(0, " + o + "%, 0)"}), e.css({
                ...
                e.each(function () {
                    ...
                    n.userID || t.error("If you want to fetch instagram images, you must define the user ID. How to get it see here - http://jelled.com/instagram/lookup-user-id"), e.html('<div class="col-xs-12">' + n.loadingText + "</div>"), t.getJSON(n.apiPath, {
                        ...
                        for (var i = 0; i < n.count; i++) {
                            ...
                            var r = {link: s.link, image: s.images.thumbnail.url, caption: s.caption};
            ...
            t(document).on("click", "a", function (a) {
                ...
                if (e && o) {
                    ...
                    n.length && (n.attr("id", ""), document.location.hash = i, n.attr("id", i), t("html, body").stop().animate({scrollTop: n.offset().top - 80}, 700), a.preventDefault())
                }
            })
            ...
            "undefined" !== t.fn.hexagonProgress && t(".youplay-hexagon-rating:not(.youplay-hexagon-rating-ready)").each(function () {
                var a = parseFloat(t(this).attr("data-max")) || 10, e = parseFloat(t(this).text()) || 0,
                ...
                t(this).css({width: o, height: o}).hexagonProgress({
                    value: e / a,
                    size: o,
                    animation: !1,
                    ...
                    lineWidth: 2,
                    clip: !0,
                    lineBackFill: {color: n},
                    lineFrontFill: {color: i}
